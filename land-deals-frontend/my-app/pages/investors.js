      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-slate-600 mt-2">Manage and track all investors</p>
          </div>
          <Link href="/investors/new">
            <span className="flex items-center space-x-2 bg-slate-900 text-white px-4 py-2 rounded-lg hover:bg-slate-800 transition cursor-pointer">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 mb-6">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0 md:space-x-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              >
                <option value="investor_name">Name</option>
                <option value="investment_amount">Investment Amount</option>
                <option value="investment_percentage">Investment %</option>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-8 text-center">
            ...
            <p className="text-slate-600 mb-4">
              {searchTerm ? 'No investors match your search criteria.' : 'Get started by adding your first investor.'}
            </p>
            <Link href="/investors/new">
              <span className="inline-flex items-center space-x-2 bg-slate-900 text-white px-4 py-2 rounded-lg hover:bg-slate-800 transition cursor-pointer">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {sortedInvestors.map((investor) => (
              <div key={investor.id} className="bg-white rounded-lg shadow-sm border border-slate-200 p-6 hover:shadow-md transition">
                <div className="flex justify-between items-start mb-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-slate-900">{investor.investor_name}</h3>
                      <p className="text-sm text-slate-600">Investor ID: {investor.id}</p>
                    </div>
                  </div>
                  <div className="flex space-x-2">
                    <Link href={`/investors/${investor.id}`}>
                      <span className="p-2 text-slate-600 hover:text-green-600 hover:bg-green-50 rounded-lg transition cursor-pointer">
                ...
                <div className="space-y-3">
                  {investor.investment_amount && (
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-sm text-slate-600">Amount: ₹{investor.investment_amount}</span>
                    </div>
                  )}
                ...
                <div className="mt-4 pt-4 border-t border-slate-200">
                  <Link href={`/investors/${investor.id}`}>
                    <span className="inline-flex items-center space-x-2 text-slate-900 hover:text-slate-700 font-medium text-sm cursor-pointer">
                      <Eye className="w-4 h-4" />
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg max-w-2xl w-full max-h-90vh overflow-y-auto">
            <div className="p-6 border-b border-slate-200">
              <h2 className="text-xl font-semibold text-slate-900">Add New Investor</h2>
            </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg max-w-2xl w-full max-h-90vh overflow-y-auto">
            <div className="p-6 border-b border-gray-200">
              <h2 className="text-xl font-semibold text-gray-900">Edit Investor</h2>
            </div>
