...
export default function InvestorDetail() {
  ...
  const handleFileUpload = async (e) => {
    ...
    try {
      ...
      await api.post(`/investors/${id}/documents`, formData, {
        headers: {
  ...
  const shareInvestorInfo = async () => {
    const shareData = {
      title: `${investor.investor_name || investor.name} - Investor Details`,
      text: `Investor: ${investor.investor_name || investor.name}\nDeals: ${deals.length}\nTotal Investment: ₹${deals.reduce((sum, d) => sum + (d.investment_amount || 0), 0).toLocaleString('en-IN')}`,
    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <h3 className="text-lg font-semibold text-slate-900 mb-2">Loading Investor Details</h3>
      ...
      <div className="min-h-screen bg-slate-50">
        ...
        <div className="flex items-center justify-center h-96">
          <div className="text-center">
            ...
            <h2 className="text-2xl font-bold text-slate-900 mb-3">Investor Not Found</h2>
            <p className="text-slate-600 mb-8">The requested investor could not be found or may have been removed.</p>
            <Link href="/investors">
  ...
  const totalInvestment = deals.reduce((sum, deal) => sum + (deal.investment_amount || 0), 0);
    ...
    <div className="min-h-screen bg-slate-50">
        ...
        <div className="px-6 py-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-3xl font-bold text-slate-900">{investor.investor_name || investor.name}</h1>
                <p className="text-slate-600 mt-1">Investor Details & Portfolio</p>
              </div>
            </div>
            <button
              onClick={shareInvestorInfo}
      ...
      <div className="w-full px-6 py-8">
        <div className="grid grid-cols-1 xl:grid-cols-4 gap-8">
          ...
          {/* Left Sidebar - Investor Info & Upload */}
                ...
                <div className="flex items-center">
                  <div className="w-16 h-16 bg-slate-200 rounded-full flex items-center justify-center mr-4">
                    <span className="text-slate-700 font-bold text-xl">
                      {(investor.investor_name || investor.name).charAt(0).toUpperCase()}
                    </span>
                  </div>
                  <div>
                    <h3 className="text-lg font-semibold text-slate-900">{investor.investor_name || investor.name}</h3>
                  ...
                  {investor.mobile && (
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-medium text-slate-900">{investor.mobile}</p>
                      </div>
                    </div>
                  )}
                  ...
                  {investor.email && (
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-medium text-slate-900">{investor.email}</p>
                      </div>
                    </div>
                  )}
                  ...
                  {investor.aadhar_card && (
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-medium text-slate-900">{investor.aadhar_card}</p>
                      </div>
                    </div>
                  )}
                  ...
                  {investor.pan_card && (
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-medium text-slate-900">{investor.pan_card}</p>
                      </div>
                    </div>
                  )}
                  ...
                  {investor.bank_name && (
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-medium text-slate-900">{investor.bank_name}</p>
                      </div>
                    </div>
                  )}
                  ...
                  {investor.account_number && (
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-medium text-slate-900">{investor.account_number}</p>
                      </div>
                    </div>
                  )}
                </div>
              ...
              <div className="p-6">
                <div className="grid grid-cols-1 gap-6">
                  <div className="text-center p-6 bg-emerald-50 rounded-lg border border-emerald-200">
                    ...
                    <p className="text-sm text-slate-600 mt-1">Investment Deals</p>
                  </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-slate-200">
              <div className="px-6 py-5 border-b border-slate-200 bg-slate-50">
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <div>
                      <h2 className="text-xl font-semibold text-slate-900">Investment Deals</h2>
                      <p className="text-sm text-slate-600 mt-1">All deals where {investor.investor_name || investor.name} has invested</p>
                    </div>
                  </div>
              ...
              {deals.length === 0 ? (
                ...
                <div className="divide-y divide-slate-200">
                  {deals.map((deal) => (
                    <div key={deal.id} className="p-6 hover:bg-slate-50 transition-all duration-200">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <h3 className="text-lg font-semibold text-slate-900 mb-3">{deal.project_name}</h3>
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                            <div className="flex items-center text-slate-600">
                              ...
                              <span>{[deal.district, deal.taluka, deal.village].filter(Boolean).join(', ') || 'Location not specified'}</span>
                            </div>
                            <div className="flex items-center text-slate-600">
                              <svg className="w-4 h-4 mr-2 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3a2 2 0 012-2h4a2 2 0 012 2v4m-6 9l2 2 4-4" />
                              </svg>
                              <span>{deal.purchase_date ? new Date(deal.purchase_date).toLocaleDateString('en-US', {
                                year: 'numeric',
                                month: 'short',
                                day: 'numeric'
                            ...
                            <div className="flex items-center text-slate-600">
                              ...
                              <span>{deal.total_area ? `${deal.total_area} ${deal.area_unit || 'sq ft'}` : 'Area not specified'}</span>
                            </div>
                            <div className="flex items-center text-slate-600">
                              <svg className="w-4 h-4 mr-2 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1" />
                              </svg>
                              <span>Investment: ₹{(deal.investment_amount || 0).toLocaleString('en-IN')}</span>
                            </div>
                          </div>
                        </div>
                        <div className="ml-6 text-right space-y-3">
                          <div>
                            <p className="text-2xl font-bold text-emerald-600">
                              ₹{(deal.investment_amount || 0).toLocaleString('en-IN')}
                            </p>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-slate-200">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-600 mt-1">All documents uploaded for this investor</p>
                    </div>
                  </div>
                  <span className="inline-flex items-center px-3 py-1 bg-slate-200 text-slate-700 rounded-full text-sm font-medium">
              ...
              {documents.length === 0 ? (
                <div className="text-center py-16">
                  ...
                  <p className="text-slate-600 max-w-md mx-auto">Upload documents using the form in the sidebar to keep track of important files for this investor.</p>
                </div>
              ) : (
                <div className="divide-y divide-slate-200">
