...
export default function NewInvestor() {
  ...
  const validateForm = () => {
    ...
    if (form.ifsc_code && !/^[A-Z]{4}0[A-Z0-9]{6}$/.test(form.ifsc_code)) {
      newErrors.ifsc_code = 'IFSC code format is invalid (e.g., SBIN0123456)';
    }
      ...
      <div className="bg-white border-b border-slate-200 w-full">
        <div className="px-6 py-8">
          <div className="flex items-center">
            ...
            <div>
              <h1 className="text-3xl font-bold text-slate-900">Add New Investor</h1>
              <p className="text-slate-600 mt-1">Create a comprehensive investor profile with all necessary details</p>
            </div>
          </div>
        </div>
      </div>
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-600 mt-1">Aadhar: 12 digits, PAN: ABCDE1234F, IFSC: BANK0123456</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-slate-900">Bank Details</p>
                    <p className="text-xs text-slate-600 mt-1">Provide accurate bank information for investment transactions</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded  border border-slate-200">
              ...
              <div className="p-6">
                <div className="space-y-3">
                  ...
                  <div className="flex items-center space-x-3">
                    <div className={`w-3 h-3 rounded-full ${form.bank_name || form.account_number ? 'bg-emerald-500' : 'bg-slate-300'}`}></div>
                    <span className="text-sm text-slate-600">Banking Details</span>
                  </div>
                  <div className="flex items-center space-x-3">
              ...
              <div className="px-6 py-5 border-b border-slate-200 bg-slate-50">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2 text-sm text-slate-500">
                    ...
                    <span>Form takes ~4 minutes</span>
                  </div>
                </div>
              </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 pl-14">
                      ...
                      <div>
                        ...
                        <select
                          ...
                          required
                        >
                          <option value="">Choose a project for investment</option>
                          {deals.map((deal) => (
