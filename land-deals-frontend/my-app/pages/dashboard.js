          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex space-x-3">
              {(user?.role === 'admin' || user?.role === 'auditor') && (
                <Link href="/deals/new">
                  <span className="inline-flex items-center rounded-md bg-slate-900 px-6 py-3 text-sm font-semibold text-white shadow-sm hover:bg-slate-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-slate-900 cursor-pointer transition-all duration-200">
                    + Create New Deal
                  </span>
                </Link>
              )}
              <Link href="/deals/deals">
                <span className="inline-flex items-center rounded-md bg-white px-6 py-3 text-sm font-semibold text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 hover:bg-slate-50 cursor-pointer transition-all duration-200">
                  View All Deals
                </span>
              </Link>
            </div>
          ...
          <div className="xl:col-span-3">
            <div className="bg-white shadow-sm rounded-lg border border-slate-200">
              <div className="px-6 py-5 border-b border-slate-200 bg-slate-50">
                <div className="flex items-center justify-between">
                  <div>
                    <h2 className="text-xl font-semibold text-slate-900">Recent Property Deals</h2>
                    <p className="mt-1 text-sm text-slate-600">
                      Overview of your latest property transactions and agreements
                    </p>
                  </div>
                  <Link href="/deals/deals">
                    <span className="text-sm font-medium text-slate-700 hover:text-slate-900 cursor-pointer inline-flex items-center px-4 py-2 border border-slate-300 rounded-md hover:bg-white transition-all duration-200">
                      View all deals
              ...
              <div className="p-6">
                {deals.length === 0 ? (
                  <div className="text-center py-16">
                    ...
                    <h3 className="text-xl font-semibold text-slate-900 mb-3">No deals available</h3>
                    ...
                    {(user?.role === 'admin' || user?.role === 'auditor') && (
                      <Link href="/deals/new">
                        <span className="inline-flex items-center rounded-md bg-slate-900 px-6 py-3 text-sm font-semibold text-white shadow-sm hover:bg-slate-800 cursor-pointer transition-all duration-200">
                  ...
                  <div className="space-y-4">
                    {deals.slice(0, 8).map((deal) => (
                      <div
                        key={deal.id}
                        className="border border-slate-200 rounded-lg hover:shadow-md hover:border-slate-300 transition-all duration-200"
                      >
                              ...
                              <div className="flex-1 min-w-0">
                                <div className="flex items-center space-x-4">
                                  ...
                                  <div className="flex items-center space-x-6">
                                    ...
                                    {deal.selling_amount && (
                                      <div className="text-right">
                                        <p className="text-sm font-medium text-emerald-600">Selling Amount</p>
                        ...
                        <div className="px-6 py-3 bg-slate-50 border-t border-slate-200">
                          <div className="flex items-center justify-between">
                            ...
                            <button
                              className="text-sm font-medium text-red-600 hover:text-red-800 hover:bg-red-50 px-3 py-1 rounded-md transition-all duration-200"
                              onClick={async (e) => {
                                e.preventDefault()
          ...
          <div className="xl:col-span-1 space-y-6">
            ...
            <div className="bg-white shadow-sm rounded-lg border border-slate-200">
              ...
              <div className="p-4 space-y-3">
                {(user?.role === 'admin' || user?.role === 'auditor') && (
                  <Link href="/deals/new">
                    <span className="w-full inline-flex items-center justify-center px-4 py-3 border border-slate-300 rounded-md text-sm font-medium text-slate-700 bg-white hover:bg-slate-50 cursor-pointer transition-all duration-200">
                      + New Deal
                    </span>
                  </Link>
                )}
            ...
            <div className="bg-white shadow-sm rounded-lg border border-slate-200">
              ...
              <div className="p-4 space-y-4">
                ...
                <div className="flex justify-between items-center py-2">
                  ...
                  <span className="text-sm font-medium text-emerald-600">{activeDeals}</span>
                </div>
                <div className="flex justify-between items-center py-2">
