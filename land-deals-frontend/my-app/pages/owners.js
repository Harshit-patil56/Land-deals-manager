          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Link href="/owners/new">
                <span className="flex items-center px-6 py-3 bg-slate-900 text-white rounded font-medium hover:bg-slate-800   cursor-pointer">
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            <div className="flex-1">
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-10 pr-4 py-3 w-full border border-slate-300 rounded focus:ring-2 focus:ring-slate-500 focus:border-slate-500  text-slate-900 placeholder-slate-400"
                />
              </div>
            </div>
            <div className="flex gap-3">
              <select
                ...
                className="px-4 py-3 border border-slate-300 rounded focus:ring-2 focus:ring-slate-500 focus:border-slate-500 bg-white text-slate-900"
              >
              ...
              <button
                ...
                className="px-4 py-3 border border-slate-300 rounded hover:bg-slate-50 flex items-center  bg-white"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
            ...
            <div className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-1">Property owners registered</p>
                </div>
                <div className="w-12 h-12 bg-slate-100 rounded flex items-center justify-center">
                  <svg className="w-6 h-6 text-slate-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-white overflow-hidden  rounded border border-slate-200">
            <div className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-slate-600">Active Owners</p>
                  <p className="text-3xl font-bold text-slate-700 mt-2">
                    {owners.filter(owner => owner.name && owner.name.trim() !== '').length}
                  </p>
                  <p className="text-xs text-slate-500 mt-1">With complete details</p>
                </div>
                <div className="w-12 h-12 bg-slate-100 rounded flex items-center justify-center">
        ...
        <div className="bg-white  rounded border border-slate-200">
          <div className="px-6 py-5 border-b border-slate-200 bg-slate-50">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <div>
                  <h2 className="text-xl font-medium text-slate-900">All Property Owners</h2>
          ...
          {sortedOwners.length === 0 ? (
            <div className="text-center py-16">
              ...
              <h3 className="text-xl font-medium text-slate-900 mb-3">No owners found</h3>
              ...
              <Link href="/owners/new">
                <span className="flex items-center px-6 py-3 border border-transparent rounded  text-sm font-medium text-white bg-slate-900 hover:bg-slate-800 cursor-pointer ">
                  <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                  </svg>
                  Add First Owner
            ...
            <div className="divide-y divide-slate-200">
              {sortedOwners.map((owner) => (
                <div key={owner.id} className="p-6 hover:bg-slate-50 ">
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4 flex-1">
                          <div className="flex items-center space-x-3">
                            <h3 className="text-lg font-medium text-slate-900">{owner.name}</h3>
                            <span className="flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-slate-100 text-slate-800">
                              ID: #{owner.id}
                            </span>
                          </div>
                    ...
                    <div className="flex items-center space-x-8">
                      <div className="text-center">
                        <p className="text-2xl font-bold text-slate-900">{owner.total_projects || 0}</p>
